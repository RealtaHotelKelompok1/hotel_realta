...
import { BookingOrdersController } from 'src/controller/booking/booking_orders.controller';
...
@Module({
  ...
  controllers: [DepartmentController,SpecialOffersController,BookingOrderDetailController,BookingOrderDetailExtraController,BookingOrdersController,SpecialOfferCouponController,UserBreakfeastController],

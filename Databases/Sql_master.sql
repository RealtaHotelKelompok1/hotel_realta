...
-- delete from master.address where addr_id = addr_id
-- delete from master.category_group where cagro_id = cagro_id
-- delete from master.policy_category_group where poca_poli_id = poca_poli_id
-- delete from master.policy where poli_id = poli_id
-- delete from master.regions where region_code = region_code
-- delete from master.country where country_id = country_id
-- delete from master.provinces where prov_id = prov_id
-- delete from master.members where memb_name = memb_name
-- delete from master.price_items where prit_id = prit_id
-- delete from master.service_task where seta_id = seta_id
